...
export IMAGE_URL=${IMAGE_URL-quay.io/jduimovich0/private-image:$CI_TYPE-$TAG}
...
export REKOR_HOST=https://rekor-server-rhtap-tas.apps.rosa.drn6n-wia34-7dd.1ag4.p3.openshiftapps.com
export IGNORE_REKOR=false
export TUF_MIRROR=https://tuf-rhtap-tas.apps.rosa.drn6n-wia34-7dd.1ag4.p3.openshiftapps.com
# Update forced CI test Tue Dec 10 17:09:42 EST 2024
